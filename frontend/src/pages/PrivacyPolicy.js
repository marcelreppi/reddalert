...
const PrivacyPolicy = () => (
  <Layout>
    ...
    >
      ...
      <p>
        Reddalert ("us", "we", or "our") operates the http://www.reddalert.me website (the
        "Service").
      </p>
      ...
      <p>
        ...
        Our Privacy Policy for Reddalert is created with the help of the{" "}
      ...
      <p>
        ...
        Terms and Conditions, accessible from http://www.reddalert.me
      </p>
      ...
      <p>Reddalert uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        If you are located outside Germany and choose to provide information to us, please note that
        we transfer the data, including Personal Data, to Germany and process it there.
      </p>
      <p>
      ...
      <p>
        Reddalert will take all steps reasonably necessary to ensure that your data is treated
      ...
      <p>
        Reddalert may disclose your Personal Data in the good faith belief that such action is
        necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Reddalert</li>
      ...
      <ul>
        <li>By email: support@reddalert.com</li>
        <li>
          By visiting this page on our website:{" "}
          <Link to="/contact">http://www.reddalert.me/contact</Link>
        </li>
      </ul>
    </div>
  </Layout>
